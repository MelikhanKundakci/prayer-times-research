...
A later [astronomical-horizon quotient test](research/raw-ratio-horizons-2026-09-25b.md) isolates one further source ambiguity. It raises exact matches by 197 but introduces five three-minute errors and worsens the later four-city cohort. It is rejected; no calculation default changes.
