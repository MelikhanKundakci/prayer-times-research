...
A separate literal-midnight branch places all nine `00:00` cells uniquely at next-day midnight. Their adjacent source labels progress through the midnight neighborhood; Reykjavík has a run of six such entries. This makes literal midnight a plausible interpretation. It does not prove that the field cannot also encode an absent value. All nine remain unresolved in the primary interpretation and existing accuracy denominators.
