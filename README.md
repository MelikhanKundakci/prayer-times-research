...
- **ARC source-display diagnostic:** a uniform UTC-row-midnight offset hypothesis explains all 36 hour-scale clock differences in eleven annual comparisons, reaching 20,014/23,754 exact and all displayed clocks within one minute. It does not establish the publisher's event dates or change the calculator; [the complete audit](methods/shia-angles/UTC-DATE-DISPLAY.md) keeps those limits explicit.
