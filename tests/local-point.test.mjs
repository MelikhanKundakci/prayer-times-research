...
test('Point API runs with network, calendars, legacy models and verification fixtures inaccessible',()=>{
  const permitted=['package.json','core/local/index.mjs','core/local/solar.mjs','core/local/northern.mjs','core/local/summer.mjs','core/local/profiles.mjs','core/local/selection.mjs','core/local/night-fraction.mjs','core/input.mjs','core/astronomy/','core/timezones/'];
